...
/// # Example
/// ```rust,ignore
/// use canopy_engine::CacheableData;
...
pub trait CacheableData: Serialize + DeserializeOwned + Sized {
    ...
    fn cache_path() -> PathBuf {
        canopy_core::paths::cache_path(Self::cache_filename())
    }
...
mod tests {
    ...
    fn test_cache_path() {
        ...
        assert!(path.to_string_lossy().contains("test_cacheable.bin"));
    }

    #[test]
    fn test_cache_round_trip() {
        // Note: This test requires workspace root to be detectable
        // In CI, this might fail gracefully
        let data = TestData {
