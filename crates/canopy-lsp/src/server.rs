...
use canopy_core::{AnalysisResult, CanopyError, Document, Word, Sentence};
use canopy_core::layer1parser::{LayerHandler, ComponentHealth};
    ...
    S: LayerHandler<Vec<Word>, Vec<Word>>,
{
    ...
    fn process_pipeline(&self, text: &str) -> AnalysisResult<AnalysisResponse> {
        ...
        layer_results.insert("layer1".to_string(), LayerResult {
        ...
        layer_results.insert("semantics".to_string(), LayerResult {
    ...
    S: LayerHandler<Vec<Word>, Vec<Word>>,
{
    ...
    fn health(&self) -> ServerHealth {
        ...
        // Check parser health
        components.insert("parser".to_string(), self.parser.health());
        ...
        let avg_response_time = if self.stats.requests > 0 {
            self.stats.total_time_us / self.stats.requests
        } else {
            0
        };
