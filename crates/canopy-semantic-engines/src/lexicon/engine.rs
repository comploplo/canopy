...
use super::types::{LexiconAnalysis, LexiconDatabase, WordClassType};
use canopy_core::paths::data_path_string;
use canopy_engine::{
    traits::{CachedEngine, DataInfo, DataLoader, SemanticEngine, StatisticsProvider},
    BaseEngine, CacheKeyFormat, EngineConfigurable, EngineCore, EngineResult, EngineStats,
...
canopy_engine::impl_engine_configurable!(LexiconConfig, min_confidence);
