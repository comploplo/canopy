...
canopy_engine::impl_engine_configurable!(VerbNetConfig);
...
impl ThematicRole {
    ...
    pub fn to_core_role(&self) -> CoreThetaRole {
        CoreThetaRole::from_role_str_or_default(&self.role_type)
    }
}
...
impl From<ThematicRole> for CoreThetaRole {
    fn from(role: ThematicRole) -> Self {
        CoreThetaRole::from_role_str_or_default(&role.role_type)
    }
}
