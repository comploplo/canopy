...
fn verbnet_available() -> bool {
    canopy_core::paths::data_path("data/verbnet/vn-gl").exists()
}

/// Check if WordNet data is available
fn wordnet_available() -> bool {
    canopy_core::paths::data_path("data/wordnet/dict").exists()
}
...
fn propbank_available() -> bool {
    canopy_core::paths::data_path("data/propbank/propbank-release/data").exists()
}

/// Check if Lexicon data is available
fn lexicon_available() -> bool {
    canopy_core::paths::data_path("data/canopy-lexicon").exists()
}
...
mod wordnet_tests {
    ...
    fn test_wordnet_hypernyms() {
        ...
        use canopy_semantic_engines::wordnet::SemanticRelation;
...
mod cross_engine_tests {
    ...
    fn test_multiple_engines_load() {
        ...
        if engines_loaded == 0 {
            ...
            eprintln!("Loaded {} semantic engines successfully", engines_loaded);
        }
    }
