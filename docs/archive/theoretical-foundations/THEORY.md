> **ARCHIVED DOCUMENT**
> This document describes the theoretical research foundations and long-term vision for canopy.
> For current implementation details, see [ARCHITECTURE.md](../../ARCHITECTURE.md) and [ROADMAP.md](../../ROADMAP.md).
> DRT and Layer 3 features described here are planned for M8+.
...
1. [Architectural Transformation](#architectural-transformation)
1. [Layer 1: Morphosyntactic Analysis](#layer-1-morphosyntactic-analysis)
1. [Layer 2: Event Semantics](#layer-2-event-semantics)
1. [Layer 3: Compositional Semantics](#layer-3-compositional-semantics)
1. [Canonical API & Interface Design](#canonical-api--interface-design)
1. [Research Contributions](#research-contributions)
